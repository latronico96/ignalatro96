				...
				<fieldset>
					...
					<div class="fila">
						...
						<span class="form-control with-17-00">Cond. de pagos</span> <select
							id="cli_condi" class="form-control with-18-00 campo">
							...
							id="cli_plazo" class="form-control with-5-00 campo" type="text"
							maxlength="2">
					</div>
					<!-- div class="fila">			
