			...
			<div class="d-block">
				...
				<fieldset>
					...
					<div class="fila">					
						...
						<button type="button" class="btn blanco form-control with-3-70 campo" id="btn_HcPrv">
							<img src="/img/iconos/glyphicons-28-search.png"	style="height: auto; filter: invert(55%);">
						</button>
						<input id="prv_nombr" class="form-control with-50-00 prv_campo" type="text" maxlength="30">	
						<span class="form-control with-5-00">IVA</span>
						<select id="prv_cliva" class="form-control with-25-00 prv_campo">
							<%=fun.GetHTMLOtion("iva_codig", "iva_nombr", "dbCondIva", "")%>
						</select>
					</div>					
					<div class="fila">
						<span class="form-control with-10-00">Telefono</span>
						<input id="prv_telef" class="form-control with-25-00 prv_campo" type="text" maxlength="30">
						<span class="form-control with-10-00">Celular</span>						
						<input id="prv_celul" class="form-control with-25-00 prv_campo" type="text" maxlength="30">
						<span class="form-control with-5-00">Doc.</span>
						<select id="prv_tpdoc" class="form-control with-10-00 prv_campo">
							<%=fun.GetHTMLOtion("doc_codig", "doc_nombre", "dbTipoDocumentos", "")%>
						</select>
						<input id="prv_nrdoc" class="form-control with-15-00 prv_campo" type="text" maxlength="11">						
					</div>
					<div class="fila">
						<span class="form-control with-10-00">Direción</span>
						<input id="prv_direc" class="form-control with-45-00 prv_campo" type="text" maxlength="60">
						...
						<input id="prv_plazo" class="form-control with-5-00 prv_campo" type="text" maxlength="2">		
					</div>
				</fieldset>
