 ...
 */
@WebServlet(asyncSupported = true, description = "Administracion de Cuentas", urlPatterns = { "/Frm_cuentas_ABM" })
public class Frm_cuentas_ABM extends HttpServlet {
